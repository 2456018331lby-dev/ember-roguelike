...
- 已新增本地生成的敌人 / Boss spritesheet，战斗中优先使用图集，保留 SVG 兜底
...
- Boss 战画面已补上阶段压力环、弹幕形状预览和更紧凑的顶部生命 HUD，减少首领读招被界面遮挡的问题
...
- `npm run test:boss-checkpoints` 会跑 baseline / smart 两套 60 seed 模拟，输出第 5/10/15/20/25 波 Boss 检查点、死亡 seed、短板标签和少量死亡样本，方便继续调中后期节奏；当前最近一次结果为 `baseline avgWave 18.83`、`smart avgWave 21.52`，其中 smart 第 25 波到达 `33/60`、通关 `27/60`。
...
最近一次验证 APK SHA256：`61FEDFD055AE46EDFC81FAAC1A96AD1CFB8488A30492F4865F2ABA0844CE337F`
